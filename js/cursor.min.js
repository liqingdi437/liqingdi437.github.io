...
!(function () {
  ...
  window.addEventListener("load", function () {
    ...
    document.addEventListener("mousemove", function (e) {
      r.now ||
        ((n.style.left = e.clientX - 8 + "px"),
        (n.style.top = e.clientY - 8 + "px")),
        (r.now = { x: e.clientX - 8, y: e.clientY - 8 }),
  ...
  requestAnimationFrame(function e() {
    r.pre
      ? ((r.pre = {
          x: t(r.pre.x, r.now.x, 0.15),
          y: t(r.pre.y, r.now.y, 0.15),
        }),
        (n.style.left = r.pre.x + "px"),
        (n.style.top = r.pre.y + "px"))
      : (r.pre = r.now),
